...
import { getRepoSourcesScriptPaths } from "./repo-sources-paths.ts";
...
> = {
  "mission-control": { allowDirty: true },
...
function main() {
  ...
  addRepo(repositories, workspaceRoot, path.join(workspaceRoot, "mission-control"), true);
